    ...
    def from_env(cls) -> "AIConfig":
        ...
        return cls(
            openai=LLMProviderConfig(
                ...
                default_model=os.environ.get("OPENAI_DEFAULT_MODEL", DEFAULT_OPENAI_MODEL)
            ),
            gemini=LLMProviderConfig(
                api_key=gemini_key,
                api_base=os.environ.get("GEMINI_API_BASE"),
                default_model=os.environ.get("GEMINI_DEFAULT_MODEL", DEFAULT_GEMINI_MODEL)
            ),
            claude=LLMProviderConfig(
                api_key=claude_key,
                api_base=os.environ.get("CLAUDE_API_BASE"),
                default_model=os.environ.get("CLAUDE_DEFAULT_MODEL", DEFAULT_CLAUDE_MODEL)
            ),
            deepseek=LLMProviderConfig(
                api_key=deepseek_key,
                api_base=os.environ.get("DEEPSEEK_API_BASE"),
                default_model=os.environ.get("DEEPSEEK_DEFAULT_MODEL", DEFAULT_DEEPSEEK_MODEL)
            ),
