    ...
    async with async_session_factory() as session, session.begin():
            ...
            sample_chats = [
                {
                    ...
                    "messages": [
                        ...
                        ("assistant", "Of course! I'm Albert, your AI assistant. How can I help you today?"),
                    ],
                },
                {
                    ...
                    "messages": [
                        ...
                        ("assistant", "Sure! Let's start by listing your top priorities for this week."),
                ...
                },
                {
                    ...
                    "messages": [
                        ...
                        ("assistant", "I'll need access to your Gmail first. Please connect your Google account in the integrations section."),
                    ],
                },
            ]
            ...
            for chat_data in sample_chats:
                existing_chat = await session.scalar(
                    select(Chat).where(Chat.user_id == user.id, Chat.title == chat_data["title"])
                )
                if existing_chat:
                ...
                logger.info("Created chat '%s' with %d messages", chat_data["title"], len(chat_data["messages"]))
