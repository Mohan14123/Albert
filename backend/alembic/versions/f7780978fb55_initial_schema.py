...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('connected', 'expired', 'disconnected', name='integration_status_enum'), nullable=False),
    ...
    sa.Column('status', sa.Enum('pending', 'completed', 'failed', name='message_status_enum'), nullable=False),
    ...
    op.create_index(op.f('ix_oauth_tokens_integration_id'), 'oauth_tokens', ['integration_id'], unique=False)
